...
export default function JournalPanel({ journal, dispatch, onClose }) {
  ...
  return (
    ...
    >
      <div
        ref={panelRef}
        className="relative aspect-[558/447] w-[min(96vw,980px)] max-w-[110vh] max-h-[88vh] bg-contain bg-center bg-no-repeat text-[#5c3825] drop-shadow-[0_26px_34px_rgba(0,0,0,0.45)]"
      ...
      >
        ...
        <input
          ...
          style={{ left: '22%', top: '14.2%', width: '8%' }}
          placeholder="Title..."
        />
        ...
        <textarea
          ...
          style={{ left: '17%', top: '18%', width: '13%', height: '59.7%' }}
